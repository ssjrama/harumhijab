    ...
    <div class="dash">
        <div class="dash-nav dash-nav-dark">
            <header>
                ...
                <a href="/admin" class="spur-logo"><i class="fas fa-user"></i> <span>Admin</span></a>
            </header>
            <nav class="dash-nav-list">
                <a href="/admin" class="dash-nav-item">
                    <i class="fas fa-home"></i> Dashboard </a>
                <a href="/admin/barang" class="dash-nav-item">
                    <i class="fas fa-box"></i> Barang </a>
                <a href="/admin/pesanan" class="dash-nav-item">
                    <i class="fas fa-file-invoice"></i> Pesanan </a>
                <a href="/admin/user" class="dash-nav-item">
                    <i class="fas fa-user"></i> Pengguna </a>
                <a href="/admin/kategori" class="dash-nav-item">
